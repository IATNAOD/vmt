    ...
    if (CurrentWorker)
      changeUser({
        ...
        permissions: {
          ...
          allCountrysValue: CurrentWorker.permissions.allCountrys.map((v, i) => ({ name: v, id: i + 1 })),
          sitesValue: CurrentWorker.permissions.sites,
          cookieValue: CurrentWorker.permissions.cookie,
        }
      })
  }, [CurrentWorker])
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="title" id="defaultModalLabel">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.editWorker}</h4>
          </div>
          <div class="modal-body">
            <form onSubmit={submitEditWorker}>
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.username}</span>
                </div>
              ...
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.email}</span>
                </div>
              ...
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.password}</span>
                </div>
                <input type="text" value={User.password} onChange={e => changeUser({ ...User, password: e.target.value })} class="form-control d-inline-block m-0" />
              </div>

              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.note}</span>
                </div>
              ...
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" >{languagesTranslate[CurrentLanguage_G].editWorkerComponent.timeout}</span>
                </div>
              ...
              <div class="row clearfix mt-2">
                <div className="col-12">
                  <strong>{languagesTranslate[CurrentLanguage_G].editWorkerComponent.searchSettings}</strong>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="ID">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.ID}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="startID">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.startID}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="IP">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.IP}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="allCountry">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.allCountrys}</label>
                  </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="sites">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.sites}</label>
                  </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="note">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.note}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="cookie">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.cookie}</label>
                  </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="important">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.important}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="allNote">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.allMark}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="paypal">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.paypal}</label>
                  </div>
                </div>
              ...
              <div class="row clearfix mt-2">
                <div className="col-12">
                  <strong>{languagesTranslate[CurrentLanguage_G].editWorkerComponent.filterSettings}</strong>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="wallets">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.wallets}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="bankCards">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.bankCards}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="empty">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.empty}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="telegram">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.telegram}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="2fa">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.teoFAplugins}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="favorites">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.favorites}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="unique">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.unique}</label>
                  </div>
                </div>
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="globalduplicates">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.globalDuplicates}</label>
                  </div>
                </div>
                ...
                <div className="col-6">
                  <div className="checkbox">
                    ...
                    <label htmlFor="notDownloaded">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.notDownloaded}</label>
                  </div>
                </div>
              ...
              <div className="w-100 d-flex justify-content-center">
                <button type={'submit'} class="btn btn-success m-0">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.editWorkerButton}</button>
              </div>

            </form>
          </div>
          <div class="modal-footer">
            <button onClick={() => deleteCurrentWorker({ _id: User._id, token: user.token })} type="button" class="btn btn-danger waves-effect" data-dismiss="modal">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.deleteWorkerButton}</button>
            <button onClick={onOutsideClick} type="button" class="btn btn-danger waves-effect" data-dismiss="modal">{languagesTranslate[CurrentLanguage_G].editWorkerComponent.closeButton}</button>
          </div>
        </div>
      </div>
    </div >
