      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="title" id="defaultModalLabel">{languagesTranslate[CurrentLanguage_G].addMarkComponent.addMark}</h4>
          </div>
          <div class="modal-body">
            <form onSubmit={submitAddMark}>
              <div class="input-group mb-2">
                <div class="input-group-prepend">
                  <span class="input-group-text" id="">{languagesTranslate[CurrentLanguage_G].addMarkComponent.name}</span>
                </div>
              ...
              <div class="input-group mb-2">
                <textarea rows="4" class="form-control no-resize" placeholder={languagesTranslate[CurrentLanguage_G].addMarkComponent.domains} value={Mark.domains} onChange={e => changeMark({ ...Mark, domains: e.target.value })} required></textarea>
              </div>
              <span className="text-warning">{languagesTranslate[CurrentLanguage_G].addMarkComponent.devideMarks}</span>

              <div class="row clearfix mt-2 mb-2">

                <div className="col-lg-7 col-md-12 d-flex align-items-center mt-2">
                  <span className={'mr-2'}>{languagesTranslate[CurrentLanguage_G].addMarkComponent.color}</span>
                </div>
                ...
                <div className="col-lg-7 col-md-12 d-flex align-items-center mt-2">
                  <span className={'mr-2'}>{languagesTranslate[CurrentLanguage_G].addMarkComponent.checkDomains}</span>
                </div>
                ...
                <div className="col-lg-7 col-md-12 d-flex align-items-center mt-2">
                  <span className={'mr-2'}>{languagesTranslate[CurrentLanguage_G].addMarkComponent.checkPassword}</span>
                </div>
                <div className="col-lg-5 col-md-0 d-flex justify-content-start">
                  <label class="switch m-0">
                ...
                <div className="col-lg-7 col-md-12 d-flex align-items-center mt-2">
                  <span className={'mr-2'}>{languagesTranslate[CurrentLanguage_G].addMarkComponent.checkHistory}</span>
                </div>
                <div className="col-lg-5 col-md-0 d-flex justify-content-start">
                  <label class="switch m-0">
              ...
              <div className="w-100 d-flex justify-content-center">
                <button type={'submit'} class="btn btn-success m-0">{languagesTranslate[CurrentLanguage_G].addMarkComponent.addMarkButton}</button>
              </div>

            </form>
          </div>
          <div class="modal-footer">
            <button onClick={onOutsideClick} type="button" class="btn btn-danger waves-effect" data-dismiss="modal">{languagesTranslate[CurrentLanguage_G].addMarkComponent.closeButton}</button>
          </div>
        </div>
      </div>
    </div>
